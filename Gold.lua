...
Status = 0
Devss = Redis:sismember(Gold.."Devss:Groups",UserId) 
Dev = Redis:sismember(Gold.."Dev:Groups",UserId)
Supcreator = Redis:sismember(Gold.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(Gold.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(Gold.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(Gold.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(Gold.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(Gold.."Special:Group"..ChatId,UserId)
...
elseif UserId == Gold then
Status = 'البوت'
elseif Devss then
Status = Redis:get(Gold.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
Status = Redis:get(Gold.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif Owners then
Status = Redis:get(Gold.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif Supcreator then
Status = Redis:get(Gold.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Creator then
Status = Redis:get(Gold.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Manger then
Status = Redis:get(Gold.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Admin then
Status = Redis:get(Gold.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الجروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الجروب'
elseif Special then
Status = Redis:get(Gold.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Gold.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Gold.."lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(Gold.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(Gold.."Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(Gold.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(Gold.."Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(Gold.."Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(Gold.."Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(Gold.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Gold.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(Gold.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Gold.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(Gold.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(Gold.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(Gold.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Gold.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(Gold.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(Gold.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Gold.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(Gold.."Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(Gold.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Gold.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(Gold.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(Gold.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Gold.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(Gold.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(Gold.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(Gold.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Gold.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(Gold.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(Gold.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(Gold.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Gold.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(Gold.."Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(Gold.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(Gold.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Gold.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(Gold.."Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(Gold.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Gold.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(Gold.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(Gold.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Gold.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(Gold.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(Gold.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Gold.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(Gold.."Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(Gold.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(Gold.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Gold.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(Gold.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(Gold.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(Gold.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Gold.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(Gold.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(Gold.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(Gold.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Gold.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(Gold.."Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(Gold.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Gold.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(Gold.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(Gold.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Gold.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(Gold.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(Gold.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(Gold.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(Gold.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(Gold.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Gold.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(Gold.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(Gold.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(Gold.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Gold.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{
BanAll = Redis:sismember(Gold.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Gold.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Gold.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Gold.."SilentGroup:Group"..ChatId,UserId)
}
end
...
elseif UserId == Gold then Status = true
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Gold).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(Gold.."chfalse")
if chh then
...
if Redis:sismember(Gold.."BanGroup:Group"..chat,useri) then
BanGroupz = "✓"
else
BanGroupz = "✗"
end
if Redis:sismember(Gold.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✓"
else
SilentGroupz = "✗"
end
if Redis:sismember(Gold.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
if Redis:sismember(Gold.."Creator:Group"..chat,useri) then
Originatorsz = "✓"
else
Originatorsz = "✗"
end
if Redis:sismember(Gold.."Manger:Group"..chat,useri) then
Managersz = "✓"
else
Managersz = "✗"
end
if Redis:sismember(Gold.."Admin:Group"..chat,useri) then
Addictivez = "✓"
else
Addictivez = "✗"
end
if Redis:sismember(Gold.."Special:Group"..chat,useri) then
Distinguishedz = "✓"
else
Distinguishedz = "✗"
end
...
local msg_id = msg.id
--var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(Gold.."Lock:channell"..msg_chat_id) then
print(Redis:get(Gold.."chadmin"..msg_chat_id))
...
Redis:incr(Gold..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(Gold) then
...
elseif Redis:sismember(Gold.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Gold.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Gold.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Gold.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Gold.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Gold.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Gold.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Gold.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Gold.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Gold.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Gold.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Gold.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Gold.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Gold.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Gold.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Gold) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Gold.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Gold.."Lock:text"..msg_chat_id) and not msg.Special then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Gold.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Gold.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Gold.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Gold) then
return false
end
local floods = Redis:hget(Gold.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Gold.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Gold.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Gold.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Gold.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Gold.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⋆ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(Gold.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Gold.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Gold.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(Gold..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(Gold..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(Gold.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Gold.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Gold.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Gold.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Gold.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Admin then -- التوجيه
local Fwd_Group = Redis:get(Gold.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Gold.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Gold.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Gold.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Gold.."lockpin"..msg_chat_id)
...
Redis:incr(Gold.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Gold.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Gold.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Gold) then
local N = (Redis:get(Gold.."Name:Bot") or "جولد")
photo = LuaTele.getUserProfilePhotos(Gold)
...
Redis:set(Gold.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Gold.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Gold.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Gold.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Gold.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Gold.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Gold.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Gold.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Gold.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Gold.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Gold.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Gold.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Gold.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Gold.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Gold.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Gold.."Lock:User:Name"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
...
if text and text:match("#[%a%d_]+") and not msg.Special then 
local Hashtak_Group = Redis:get(Gold.."Lock:hashtak"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
...
if text and text:match("/[%a%d_]+") and not msg.Special then 
local comd_Group = Redis:get(Gold.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Gold.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Gold.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Gold.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Gold.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Gold.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Gold.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Gold.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Gold.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end end
if text and (Redis:get(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Gold.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Gold.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Gold.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Gold.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Gold.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Gold.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Gold.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Gold.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Gold.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Gold.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Gold.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Gold.."Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Gold.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Gold.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Gold.."All:Get:Reides:Commands:Group"..text)
Redis:del(Gold.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Gold.."All:Command:List:Group",text)
...
Redis:del(Gold.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Gold.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Gold.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Gold.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Gold.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Gold.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Gold.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Gold.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Gold.."All:Command:List:Group",text)
Redis:del(Gold.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(Gold.."lockalllll"..msg_chat_id) == "off" then
...
if text and Redis:get(Gold.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Gold.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Gold.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(Gold.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Gold.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Gold.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Gold.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Gold.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Gold.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Gold.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Gold.."Command:List:Group"..msg_chat_id,text)
Redis:del(Gold.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Gold.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Gold.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"•  تم الغاء حفظ الرابط","md",true) 
end
Redis:set(Gold.."Group:Link"..msg_chat_id,text)
Redis:del(Gold.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"•  تم حفظ الرابط بنجاح","md",true) 
end 
if Redis:get(Gold.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Gold.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"• تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Gold.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Gold.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ ترحيب الجروب","md",true) 
end
if Redis:get(Gold.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Gold.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Gold.."Group:Rules" .. msg_chat_id,text) 
Redis:del(Gold.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(Gold.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Gold.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(Gold.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Gold.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Gold.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Gold.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(Gold.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Gold.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(Gold.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(Gold.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Gold.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(Gold.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(Gold.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(Gold.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(Gold.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
...
Redis:set(Gold.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(Gold.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(Gold.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Gold.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Gold.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Gold.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(Gold.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(Gold.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(Gold.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Gold.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(Gold.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Gold.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Gold.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Gold.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود ","md",true)  
return false
end end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= Gold then
local test = Redis:get(Gold.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Gold.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Gold.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Gold.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(Gold.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Gold.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(Gold.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(Gold.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(Gold.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Gold.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(Gold.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(Gold.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(Gold.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Gold.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(Gold.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الرد \n• ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Gold.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Gold.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Gold.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Gold..''..v..text)
end
Redis:del(Gold.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Gold.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود العامه","md",true)  
end end
if text and not Redis:get(Gold.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(Gold..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(Gold.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Gold.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Gold.."Add:Rd:Sudo:stekr"..text) 
local Text = Redis:get(Gold.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Gold.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(Gold.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(Gold.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(Gold.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(Gold.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(Gold.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(Gold.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(Gold.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Gold..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Gold..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(Gold.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text and not Redis:get(Gold.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Gold.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Gold.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Gold.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
local Texingt = Redis:get(Gold.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Gold.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(Gold.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(Gold.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(Gold.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(Gold.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Gold.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(Gold.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(Gold.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Gold..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if Redis:get(Gold.."Gold:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Gold.."Gold:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Gold.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Gold.."Gold:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Gold.."Gold:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Gold.."Gold:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Gold.."Gold:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Gold.."Gold:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Gold.."Gold:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Gold.."Gold:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Gold.."Gold:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Gold.."Gold:PinMsegees:"..v,text)
end
end
...
if Redis:get(Gold.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Gold.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Gold.."Num:User:Pv") 
...
if Redis:get(Gold.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Gold.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Gold.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Gold.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Gold.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(Gold.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(Gold.."ch:admin")
...
if Redis:get(Gold.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Gold.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Gold..'GetTexting:DevGold'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء ⋆' then 
Redis:del(Gold..'GetTexting:DevGold'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم الغاء حفظ كليشة المطور')
end
Redis:set(Gold..'Texting:DevGold',text)
Redis:del(Gold..'GetTexting:DevGold'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم حفظ كليشة المطور')
end
if Redis:get(Gold.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Gold.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Gold.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Gold.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم تعين الايدي عام',"md",true)  
end
if Redis:get(Gold.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تعين الايدي","md",true)  
Redis:del(Gold.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Gold.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Gold.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Gold.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Gold.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تغيير اسم البوت","md",true)  
end 
Redis:del(Gold.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Gold.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⋆ تم تغيير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Gold.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Gold.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⋆ تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(Gold.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Gold.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⋆ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Gold.."Game:Smile"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Smile"..msg.chat_id) then
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Gold.."Game:Smile"..msg.chat_id)
...
if Redis:get(Gold.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Monotonous"..msg.chat_id) then
Redis:del(Gold.."Game:Monotonous"..msg.chat_id)
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(Gold.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Riddles"..msg.chat_id) then
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Gold.."Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(Gold.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Gold.."Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(Gold.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(Gold.."Game:enkliz"..msg.chat_id) then
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Gold.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(Gold.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Gold.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(Gold.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Reflection"..msg.chat_id) then
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Gold.."Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(Gold.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Gold.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Gold.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Gold.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Gold.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Gold.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Gold.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Gold.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Gold.."Game:Difference"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Difference"..msg.chat_id) then 
Redis:del(Gold.."Game:Difference"..msg.chat_id)
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - المختلف","md",true)  
end
end
if Redis:get(Gold.."Game:Example"..msg.chat_id) then
if text == Redis:get(Gold.."Game:Example"..msg.chat_id) then 
Redis:del(Gold.."Game:Example"..msg.chat_id)
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ لقد فزت في اللعبه \n⋆ العب مره اخره وارسل - امثله","md",true)  
end
end
if text then
local NewCmmd = Redis:get(Gold.."All:Get:Reides:Commands:Group"..text) or Redis:get(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(Gold.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(Gold.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(Gold.."chfalse")
Redis:set(Gold.."chfalse",ch)
Redis:del(Gold.."ch:admin")
Redis:set(Gold.."ch:admin",data.result.invite_link)
else
...
if tonumber(Gold) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Gold..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Gold.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Gold.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Gold.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Gold.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Gold.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Gold.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Gold) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Gold.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Gold.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Gold.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Gold.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Gold.."Supcreator:Group"..idg,idASAS)
end;end
end
...
Redis:set(Gold.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Gold.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء ⋆' then   
Redis:del(Gold.."AddSudosNew"..msg_chat_id)
...
Redis:set(Gold.."AddSudosNew"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(Gold.."SendBcBot") then
...
Redis:setex(Gold.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Gold.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Gold.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(Gold.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(Gold.."Gold:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if not Redis:get(Gold.."chmembers") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ الامر معطل بالفعل* ',"md",true)  
end
Redis:del(Gold.."chmembers")
...
local Info_Members = Redis:smembers(Gold.."BanAll:Groups") 
...
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Gold.."Gold11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Gold.."Gold11:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id, '\n⋆ ارسل الكلمه الان')
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Gold11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Gold..'Gold11:Add:Rd:Sudo:Text'..text)
Redis:del(Gold..'Gold11:Add:Rd:Sudo:Text1'..text)
Redis:del(Gold..'Gold11:Add:Rd:Sudo:Text2'..text)
Redis:del(Gold.."Gold11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Gold.."Gold11:List:Rd:Sudo", text)
...
local list = Redis:smembers(Gold.."Gold11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Gold.."Gold11:Add:Rd:Sudo:Text"..v) 
Redis:del(Gold.."Gold11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Gold.."Gold11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Gold.."Gold11:List:Rd:Sudo")
end
...
Redis:set(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Gold.."Gold11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"⋆ ارسل الكلمه التي تريد حذفها")
end
if text then  
local test = Redis:get(Gold.."Gold11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Gold.."Gold11:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = Redis:get(Gold.."Gold11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Gold.."Gold11:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = Redis:get(Gold.."Gold11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Gold.."Gold11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Gold.."Gold11:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = Redis:get(Gold.."Gold11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Gold.."Gold11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Gold.."Gold11:Add:Rd:Sudo:Text2"..text)   
...
local list = Redis:smembers(Gold.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Gold.."Add:Rd:Sudo:Gif"..v)
Redis:del(Gold.."Add:Rd:Sudo:vico"..v)
Redis:del(Gold.."Add:Rd:Sudo:stekr"..v)
Redis:del(Gold.."Add:Rd:Sudo:Text"..v)
Redis:del(Gold.."Add:Rd:Sudo:Photo"..v)
Redis:del(Gold.."Add:Rd:Sudo:Photoc"..v)
Redis:del(Gold.."Add:Rd:Sudo:Video"..v)
Redis:del(Gold.."Add:Rd:Sudo:Videoc"..v)
Redis:del(Gold.."Add:Rd:Sudo:File"..v)
Redis:del(Gold.."Add:Rd:Sudo:Audio"..v)
Redis:del(Gold.."Add:Rd:Sudo:Audioc"..v)
Redis:del(Gold.."Add:Rd:Sudo:video_note"..v)
Redis:del(Gold.."List:Rd:Sudo")
end
...
Redis:set(Gold.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:set(Gold.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},
...
if text and not Redis:sismember(Gold.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(Gold.."Spam:Group"..msg.sender.user_id) 
end
if text == 'تفعيل الاشتراك الاجباري لكل الاعضاء ⋆' or text == 'تفعيل الاشتراك الاجباري لكل الاعضاء' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ هذا الامر يخص  '..Controller_Num(1)..'* ',"md",true)  
end
if not Redis:get(Gold.."chfalse") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(Gold.."chmembers","on")
...
Redis:set(Gold.."ch:addd"..msg.sender.user_id,"on")
...
local Groups = Redis:smembers(Gold..'ChekBotAdd')  
local UsersBot = Redis:smembers(Gold..'Num:User:Pv')  
local Get_Json = '{"BotId": '..Gold..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Gold.."Supcreator:Group"..v)
local Constructor = Redis:smembers(Gold.."Creator:Group"..v)
local Manager = Redis:smembers(Gold.."Manger:Group"..v)
local Admin = Redis:smembers(Gold.."Admin:Group"..v)
local Vips = Redis:smembers(Gold.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(Gold..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⋆ عدد احصائيات البوت الكامله \n•━─━─━─━─━─━─━─━•\n⋆ عدد المجموعات : '..(Redis:scard(Gold..'ChekBotAdd') or 0)..'\n⋆ عدد المشتركين : '..(Redis:scard(Gold..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Gold..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(Gold..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
if Redis:sismember(Gold.."ChekBotAdd",msg_chat_id) then
...
Redis:sadd(Gold.."ChekBotAdd",msg_chat_id)
Redis:set(Gold.."Status:Id"..msg_chat_id,true) ;Redis:del(Gold.."Status:Reply"..msg_chat_id) ;Redis:del(Gold.."Status:ReplySudo"..msg_chat_id) ;Redis:set(Gold.."Status:BanId"..msg_chat_id,true) ;Redis:set(Gold.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Gold.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Gold.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(Gold.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Gold.."ChekBotAdd",msg_chat_id) then
if text == 'ايدي' then
...
local TotalMsg = Redis:get(Gold..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Gold..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Gold.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Gold.."Num:Add:Games"..msg.chat_id..UserId) or 0
if id3am then
...
if msg.reply_to_message_id == 0 then
if not Redis:get(Gold.."Status:Id"..msg_chat_id) then
return false
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Gold.."ch:admin")
...
local TotalMsg = Redis:get(Gold..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Gold..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Gold.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Gold.."Set:Id:Group"..msg_chat_id) or Redis:get(Gold.."Set:Id:Groups")
if Redis:get(Gold.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Gold..'Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Gold..'Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
...
local TotalMsg = Redis:get(Gold..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Gold..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
'\n⋄︙User Name ↬ @'..UserName..
...
local vip = Redis:smembers(Gold.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(Gold.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(Gold.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(Gold.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(Gold.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(Gold.."Owners:Group"..msg_chat_id) 
local dev = Redis:smembers(Gold.."Dev:Groups") 
local devss = Redis:smembers(Gold.."Devss:Groups") 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',data = {
...
TheBasics = Redis:sismember(Gold.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(Gold.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(Gold.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(Gold.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(Gold.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(Gold.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(Gold.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(Gold.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(Gold.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(Gold.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(Gold.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(Gold.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(Gold.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(Gold.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Gold).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Gold).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✓ ❭' else change_info = '❬ ✗ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Gold.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Gold.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Gold.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Gold.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Gold.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Gold.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
----تنزيل تسليه -----
if TextMsg == "خول" then
if not Redis:sismember(Gold.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ اتعالج خلاص ?? ").Reply,"md",true)  
else
Redis:srem(Gold.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(Gold.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(Gold.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(Gold.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Gold.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(Gold.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Gold.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ احسن برضوا دا عيل نجس 😂 ").Reply,"md",true)  
else
Redis:srem(Gold.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(Gold.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Gold.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Gold.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Gold.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Gold.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Gold.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Gold.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Gold.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Gold.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(Gold.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Gold.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Gold.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Gold.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Gold.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Gold.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Gold.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Gold.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."Special:Group"..msg_chat_id,UserId[2]) 
...
return LuaTele.sendText(msg_chat_id,msg_id,Goldusername,"md",false, false, false, false, reply_markup)
end
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(Gold) then
    return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يحيحان ","md",true)  
  end
  if Redis:sismember(Gold..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
    ...
    if Redis:sismember(Gold..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(Gold..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(Gold..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(Gold..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تنزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(Gold..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(Gold..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(Gold..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(Gold..msg_chat_id.."mutlqat:")
...
Redis:set(Gold.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Gold.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Gold.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Gold.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Gold.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Gold.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Gold.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Gold.."Devss:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Dev:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⋆ قائمه مطورين البوت \n •━─━─━─━─━─━─━─━•*\n'
...
local Info_Members = Redis:smembers(Gold.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Gold.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Gold.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Gold.."Status:Id"..msg_chat_id,true) 
...
Redis:set(Gold.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:del(Gold.."Status:Reply"..msg_chat_id) 
...
Redis:del(Gold.."Status:ReplySudo"..msg_chat_id) 
...
Redis:set(Gold.."Status:BanId"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(Gold.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Gold.."Status:Welcome"..msg_chat_id) 
...
Redis:del(Gold.."Status:Id"..msg_chat_id) 
...
Redis:del(Gold.."Status:IdPhoto"..msg_chat_id) 
...
Redis:set(Gold.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(Gold.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(Gold.."Status:BanId"..msg_chat_id) 
...
if not Redis:sismember(Gold.."BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Gold.."BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Gold.."ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Gold.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Creator and not Redis:get(Gold.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Gold.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Gold.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Gold.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Gold.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Gold.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(Gold.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Gold.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Gold.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Gold.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Gold.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Gold.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Gold.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(Gold.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Gold.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Gold.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Gold.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Gold.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Gold.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Gold.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Gold.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Gold.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Gold.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Gold.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Gold.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Gold.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Gold.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Gold.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Gold.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Gold.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Gold.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Gold.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(Gold.."LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Gold.."ch:admin")
...
Redis:set(Gold.."myphoto"..msg_chat_id,"off")
...
Redis:del(Gold.."mybuti"..msg_chat_id)
...
Redis:set(Gold.."mybuti"..msg_chat_id,"off")
...
Redis:del(Gold.."sayy"..msg_chat_id)
...
Redis:set(Gold.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ تم امر امر قول* ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(Gold.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(Gold.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(Gold.."myphoto"..msg_chat_id) == "off" then
...
local Added_Me = Redis:get(Gold.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if Redis:get(Gold.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("http://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(Gold.."chadmin"..msg_chat_id,ch) 
...
Redis:del(Gold.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(Gold.."chadmin"..msg_chat_id) then
LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Gold.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(Gold.."chadmin"..msg_chat_id) then
Redis:del(Gold.."chadmin"..msg_chat_id) 
...
Redis:set(Gold.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(Gold.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(Gold.."Lock:text"..msg_chat_id,true) 
...
Redis:set(Gold.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Gold.."lockalllll"..msg_chat_id,"off")
...
Redis:set(Gold.."lockalllll"..msg_chat_id,"on")
...
Redis:set(Gold.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Gold.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(Gold.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Gold..''..lock..msg_chat_id,"del")    
end
...
Redis:del(Gold.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Gold.."Lock:channell"..msg_chat_id)  
...
Redis:hset(Gold.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(Gold.."Lock:text"..msg_chat_id)  
...
Redis:del(Gold.."Lock:Join"..msg_chat_id)  
...
Redis:del(Gold.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Gold.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(Gold.."lockpin"..msg_chat_id)  
...
Redis:del(Gold.."Lock:edit"..msg_chat_id) 
...
Redis:del(Gold.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Gold..''..lock..msg_chat_id)    
end
...
Redis:hset(Gold.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Gold.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Gold.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Gold.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Gold.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Gold.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Link"..msg_chat_id)  
...
Redis:set(Gold.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(Gold.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(Gold..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(Gold..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(Gold..'lock:Fshar'..msg.chat_id) 
...
Redis:del(Gold..'lock:Fars'..msg.chat_id) 
...
Redis:set(Gold.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Photo"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Video"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Animation"..msg_chat_id)  
...
Redis:set(Gold.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:geam"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Audio"..msg_chat_id)  
...
Redis:set(Gold.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:vico"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(Gold.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:forward"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Document"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Contact"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Spam"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Gold.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(Gold.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Gold.."Status:Welcome"..msg_chat_id) then
...
Redis:del(Gold.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(Gold.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Gold.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Gold.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Gold.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Gold.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Gold.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Gold.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(Gold.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Gold.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Gold..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ ارسل الان { ملصق ,متحركه ,صوره ,رساله }*',"md",true)  
end
...
Redis:set(Gold.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Gold.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Gold.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Gold.."All:Get:Reides:Commands:Group"..v)
Redis:del(Gold.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Gold.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Gold.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Gold.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Gold.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Gold.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Gold.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✓ ❭' else Statuslink = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✓ ❭' else StatusWelcome = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✓ ❭' else StatusId = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✓ ❭' else StatusIdPhoto = '❬ ✗ ❭'
end
if not Redis:get(Gold.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if not Redis:get(Gold.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✓ ❭' else StatusReplySudo = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✓ ❭' else StatusBanId = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✓ ❭' else StatusSetId = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✓ ❭' else StatusGames = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✓ ❭' else Statuskickme = '❬ ✗ ❭'
end
if Redis:get(Gold.."Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(Gold.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Gold.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Gold.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Gold.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Gold.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Gold.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Gold.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Gold.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Gold.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Gold.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Gold.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
if Redis:smembers(Gold.."Supcreator:Group"..msg_chat_id) then
Redis:del(Gold.."Supcreator:Group"..msg_chat_id) 
end
if Redis:smembers(Gold.."Creator:Group"..msg_chat_id) then
Redis:del(Gold.."Creator:Group"..msg_chat_id) 
end
if Redis:smembers(Gold.."Manger:Group"..msg_chat_id) then
Redis:del(Gold.."Manger:Group"..msg_chat_id) 
end
if Redis:smembers(Gold.."Admin:Group"..msg_chat_id) then
Redis:del(Gold.."Admin:Group"..msg_chat_id) 
end
if Redis:smembers(Gold.."Special:Group"..msg_chat_id) then
Redis:del(Gold.."Special:Group"..msg_chat_id) 
end
...
Redis:del(Gold..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
Redis:del(Gold..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Gold..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد رسائلك هنا*~ '..(Redis:get(Gold..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد التعديلات هنا*~ '..(Redis:get(Gold..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد جهاتك المضافه هنا*~ '..(Redis:get(Gold.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Gold.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⋆ ارسل الان النص
⋆ يمكنك اضافه :
...
Redis:setex(Gold.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⋆ ارسل الان النص
⋆ يمكنك اضافه :
⋆ `#username` » اسم المستخدم
...
Redis:del(Gold.."Set:Id:Group"..msg.chat_id)
...
Redis:del(Gold.."klb:Group"..msg_chat_id) 
...
Redis:del(Gold.."kholat:Group"..msg_chat_id) 
...
Redis:del(Gold.."2rd:Group"..msg_chat_id) 
...
Redis:del(Gold.."8by:Group"..msg_chat_id) 
...
Redis:del(Gold.."3ra:Group"..msg_chat_id) 
...
Redis:del(Gold.."smb:Group"..msg_chat_id) 
...
Redis:del(Gold.."mar:Group"..msg_chat_id) 
...
Redis:del(Gold.."twhd:Group"..msg_chat_id) 
...
Redis:del(Gold.."wtka:Group"..msg_chat_id) 
...
Redis:del(Gold.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(Gold.."SilentGroup:Group"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Goldb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(Gold.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Gold.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) 
Redis:del(Gold.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Gold.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
Redis:del(Gold.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Gold.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
Redis:del(Gold.."List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود \n━━━━━━━━━━━━\n"
for k,v in pairs(list) do
if Redis:get(Gold.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه •"
elseif Redis:get(Gold.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه •"
elseif Redis:get(Gold.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق •"
elseif Redis:get(Gold.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله •"
elseif Redis:get(Gold.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره •"
elseif Redis:get(Gold.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو •"
elseif Redis:get(Gold.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف •"
elseif Redis:get(Gold.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه •"
elseif Redis:get(Gold.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو •"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Gold.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},}}
...
if text then   
if Redis:get(Gold..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
local test = Redis:get(Gold..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
Redis:sadd(Gold.."Add:Rd:array:Text"..test..msg_chat_id,text)  
_key = {
...
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(Gold.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(Gold.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(Gold.."Add:Rd:array:Text"..gery..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:srem(Gold.."Add:Rd:array:Text"..gery..msg_chat_id,text)
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  تم حذفه بنجاح .* ',"md",true)
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(Gold.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(Gold..'List:array'..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:set(Gold.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(Gold.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(Gold.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end

if text and text:match("^(.*)$") then
if Redis:get(Gold.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Gold.."Set:array"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Gold.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Gold.."List:array"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Gold.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == "delrd" then
Redis:set(Gold.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Gold.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(Gold.."Add:Rd:array:Text"..text..msg_chat_id)
Redis:srem(Gold..'List:array'..msg_chat_id, text)
...
Redis:set(Gold.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
send_inlin_key(msg_chat_id,"⋆  ارسل الكلمه التي تريد حذفها",inlin,msg_id)
return false 
end
if text then
if  Redis:sismember(Gold..'List:array'..msg_chat_id,text) then
local list = Redis:smembers(Gold.."Add:Rd:array:Text"..text..msg_chat_id)
...
local list = Redis:smembers(Gold..'List:array'..msg_chat_id..'')
...
local list = Redis:smembers(Gold..'List:array'..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Gold.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(Gold..'List:array'..msg_chat_id)
end
...
Redis:set(Gold.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
text = "\n⋆ قائمة الردود العامه \n•━─━─━─━─━─━─━─━•\n"
for k,v in pairs(list) do
if Redis:get(Gold.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:vico"..v) then
db = "بصمه ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:Text"..v) then
db = "رساله ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:Photo"..v) then
db = "صوره ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:Video"..v) then
db = "فيديو ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:File"..v) then
db = "ملف ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ⋆"
elseif Redis:get(Gold.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو ⋆"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Gold..'GetTexting:DevGold'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Gold..'Texting:DevGold')
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevGold = Redis:get(Gold..'Texting:DevGold')
if TextingDevGold then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevGold,"md",true)  
else
...
if Redis:get(Gold.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if text and Redis:get(Gold..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(Gold..msg.chat_id.."name_mean"..msg.sender.user_id)
...
Redis:set(Gold..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
keyboard.inline_keyboard = {
{
{text = '𝐃𝐞𝐯: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/DV_GOLD"},{text = '𝐂𝐡: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/AKJA0"},
},
{
{text = '𝐄𝐱𝐩 𝐒𝐨𝐮𝐫𝐜𝐞', url = "http://t.me/exp_gold"}
},
}
...
Redis:setex(Gold.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Gold.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(Gold.."Name:Bot") or "جولد") then
local NamesBot = (Redis:get(Gold.."Name:Bot") or "جولد")
local NameBots = {
"قلب "..NamesBot ,
"معاك",
"نعم ؟",
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Gold)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⋆ البوت عضو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره*',"md")
Redis:srem(Gold..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Gold..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Gold..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Gold..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Gold.."Game:Smile"..msg.chat_id,SM)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Gold.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Gold.."Game:Riddles"..msg.chat_id,name)
...
if Redis:get(Gold.."Status:Games"..msg.chat_id) then
Redis:del(Gold.."Set:Country"..msg.chat_id)
...
Redis:set(Gold.."Game:Countrygof"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Gold.."Status:Games"..msg.chat_id) then
Redis:del(Gold.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Gold.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Gold.."Status:Games"..msg.chat_id) then
Redis:del(Gold.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Gold.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(Gold.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Gold.."Game:Difference"..msg.chat_id,name)
...
Redis:set(Gold.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Gold.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Gold.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:incrby(Gold.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(Gold.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Gold.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:sadd(Gold..'Num:User:Pv',msg.sender.user_id)  
if not msg.Devss then
if not Redis:get(Gold.."Start:Bot") then
local CmdStart = '\n⋄︙مرحبا انا بوت '..(Redis:get(Gold.."Name:Bot") or "جولد")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Gold.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Gold.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(Gold.."TwaslBot") and not Redis:sismember(Gold.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Gold.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Gold.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Gold..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⋆ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Gold..'BaN:In:Tuasl',Info_User)  
...
reply_markup = {
inline_keyboard ={
{{text ="• Gold Source", url= "https://t.me/AKJA0"}},
}
},
},
}
...
Redis:srem(Gold.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Gold..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Gold.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(Gold.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if Redis:get(Gold.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Gold) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Gold..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == Gold then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Gold..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Gold.."Lock:edit"..data.chat_id) then
...
data.The_Controller = 1
elseif Redis:sismember(Gold.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(Gold.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(Gold.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(Gold.."Supcreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(Gold.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(Gold.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(Gold.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(Gold.."Special:Group"..ChatId,IdUser) == true then
...
if Redis:sismember(Gold.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(Gold.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(Gold.."Supcreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(Gold.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(Gold.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(Gold.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Gold.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(Gold.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(Gold.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Gold.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(Gold.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(Gold.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Gold.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(Gold.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(Gold.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(Gold.."Creator:Group"..ChatId,UserId[2])
Redis:srem(Gold.."Special:Group"..ChatId,UserId[2])
Redis:srem(Gold.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(Gold.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Gold.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Gold.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(Gold.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Gold.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Gold.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(Gold.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local Info_Members = Redis:smembers(Gold.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Creator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Manger:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Admin:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Gold.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
Redis:incrby(Gold.."Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(Gold.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ Gold',url='http://t.me/AKJA0'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ Gold',url='http://t.me/AKJA0'}},}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Gold.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(Gold.."ChekBotAdd",UserId[2])
Redis:set(Gold.."Status:Id"..UserId[2],true) ;Redis:del(Gold.."Status:Reply"..UserId[2]) ;Redis:del(Gold.."Status:ReplySudo"..UserId[2]) ;Redis:set(Gold.."Status:BanId"..UserId[2],true) ;Redis:set(Gold.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Gold.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Gold.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'تعط','تعطيل الايدي بالصوره')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"تعط")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'تفع','تفعيل الايدي بالصوره')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"تفع")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'ا','ايدي')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"ا")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'م','رفع مميز')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"م")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'اد', 'رفع ادمن')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"اد")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'مد','رفع مدير')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"مد")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'من', 'رفع منشئ')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"من")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'اس', 'رفع منشئ اساسي')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"اس")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'مط','رفع مطور')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"مط")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'ثانوي','رفع مطور ثانوي')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"ثانوي")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'تك','تنزيل الكل')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"تك")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'ر','الرابط')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"ر")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'رر','ردود المدير')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"رر")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'مسح المكتومين','ممكتومين')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"ممكتومين")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'رد','اضف رد')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"رد")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'سح','مسح سحكاتي')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"سح")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'رس','مسح رسائلي')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"رس")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'غ','غنيلي')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"غ")
Redis:set(Gold.."Get:Reides:Commands:Group"..ChatId..":"..'#','مسح قائمه العام')
Redis:sadd(Gold.."Command:List:Group"..ChatId,"#")
local txxt = [[
⋆ تم ترتيب الاوامر بالشكل التالي ~
⋆  ايدي - ا .
⋆  رفع مميز - م .
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Gold.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Gold.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Gold.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Gold.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Gold.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Gold..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Gold.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Owners:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Creator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Manger:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Admin:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Gold.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
